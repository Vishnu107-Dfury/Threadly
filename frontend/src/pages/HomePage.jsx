              ...
              return (
                ...
                >
                  ...
                  <div className="p-2.5 sm:p-4 space-y-2 flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center justify-between gap-1 text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400 mb-1">
                    ...
                    <div className="pt-1.5 sm:pt-2 flex items-center justify-between border-t border-slate-100 dark:border-slate-800 gap-1">
                      <div className="min-w-0">
                        <span className="text-xs sm:text-base font-bold text-slate-900 dark:text-slate-100">
